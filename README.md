# Totem Tender 
## An idle mini‑game inside WoW Classic Anniversary

### Goal: 
Keep the environment healthy and in harmony by unlocking and summoning Shaman totems.

### Win: 
Reach Shaman Level 60 while the current environment is Thriving.

### Loss: 
Environment health drops to 0 (Collapses).
